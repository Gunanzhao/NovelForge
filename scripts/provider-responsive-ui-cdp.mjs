...
const server=createServer((request,response)=>{
  ...
  request.on('end',()=>{
    ...
    setTimeout(()=>{response.writeHead(200,{'Content-Type':'application/json'});response.end(JSON.stringify({choices:[{message:{content:'风很暖。灯很亮。'}}],model:'synthetic-writer'}))},4000)
  })
})
