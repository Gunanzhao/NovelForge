...
- [x] RC-08 当前 HEAD GitHub Actions：HEAD `5f47776` 已推送，run `33667077924` 的 Frontend/Rust 两个 job 均 success。
...
- 2026-09-03：按用户授权将 HEAD `5f47776` 推送到 GitHub `main`；run `33667077924` 的 Frontend checks 与 Rust checks 均 success。远程 `v1.0.0-rc.1` tag 尚未创建，原生附件选择器仍保留系统焦点/列表刷新竞态记录。
