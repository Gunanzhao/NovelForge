...
当前开发候选未发布；ISSUE-01/02 已修复，新增自动化回归和 Windows 构建已通过，三种桌面 E2E 均已通过，源码基线 CI 已通过。
...
- 完整验收记录见 [TEST_REPORT](TEST_REPORT.md#rc3-validation) 和 [rc.3 草案](docs/releases/v1.1.0-rc.3.md)。
