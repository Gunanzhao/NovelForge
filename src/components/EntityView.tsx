...
export function EntityView({ kind }: { kind: EntityKind }) {
  ...
  const visibleEntities = useMemo(() => {
    ...
    return kind === 'location'
      ? filtered.slice().sort((left, right) => locationDepth(left, locationEntities) - locationDepth(right, locationEntities) || left.title.localeCompare(right.title, 'zh-CN'))
      : filtered
  }, [entities, filter, kind, locationEntities])
