...
export default function App() {
  ...
  const columns = fitWorkspaceColumns(workspacePreferences, viewportWidth, sidebarOpen && !focusMode, inspectorVisible && !focusMode)
  const layoutStyle = {
