...
- 当前候选已推送到 GitHub `main`（HEAD `18c0f81`）；run `33668961869` 的 Frontend/Rust 两个 job 均为 success。`v1.0.0-rc.1` 远程 tag 尚未创建；官方 WebDriver 原生附件选择器复跑仍记录为系统焦点/列表刷新竞态，未虚报为通过。
